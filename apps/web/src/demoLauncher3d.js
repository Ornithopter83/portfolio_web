...
const defaultModelUrl = new URL('models/witch.glb', window.location.origin + baseUrl).href;
...
export async function startDemoLauncher(canvasId) {
    ...
    await loadCharacterModel(defaultModelUrl);
...
export async function loadCharacterModel(url = defaultModelUrl) {
